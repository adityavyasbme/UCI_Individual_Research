...
# -*- coding: utf-8 -*-
"""
Created on Thu Jan 23 15:13:25 2020
...
row2 = augment_row_byvalue_all(X_train.iloc[[0]],ignore_index=-1,times=5,std=0.001,sample_size=1000,add_initial=True)
...
df = augment(X_train,y_train,tim)
X = df.iloc[:, 1:]
y = df.iloc[:, 0]
